...
class Cache extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('loadingScreens/loadingscreen-' + FlxG.random.int(1, 18)));
		menuBG.screenCenter();
		add(menuBG);

		shitz = new FlxText(20, 150, 5000, "VS Blu\nDEMO PREVIEW\nHappy new year!", 12);
	...
	function cache()
	{
		...
		MusicBeatState.switchState(new FunnyImage());
	}
